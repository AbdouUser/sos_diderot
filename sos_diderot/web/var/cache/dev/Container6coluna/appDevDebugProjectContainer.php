...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'security.user.provider.concrete.staff' => 'getSecurity_User_Provider_Concrete_StaffService.php',
            'security.user.provider.concrete.student' => 'getSecurity_User_Provider_Concrete_StudentService.php',
        ...
        $this->privates = [
            ...
            'security.user.provider.concrete.staff' => true,
            'security.user.provider.concrete.student' => true,
