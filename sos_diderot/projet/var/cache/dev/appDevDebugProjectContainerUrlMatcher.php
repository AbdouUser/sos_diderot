...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/staff')) {
            ...
            // calendarStaf
            if (0 === strpos($pathinfo, '/staff/calendar') && preg_match('#^/staff/calendar/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, ['_route' => 'calendarStaf']), array (  '_controller' => 'AppBundle\\Controller\\StaffController::SOSPCalendar',));
            }
        ...
        elseif (0 === strpos($pathinfo, '/student')) {
            ...
            // rdv
            if ('/student/rdv' === $pathinfo) {
                $ret = array (  '_controller' => 'AppBundle\\Controller\\StudentController::SOSPRdv',  '_route' => 'rdv',);
                if (!in_array($requestMethod, ['POST'])) {
                    $allow = array_merge($allow, ['POST']);
                    goto not_rdv;
                }
