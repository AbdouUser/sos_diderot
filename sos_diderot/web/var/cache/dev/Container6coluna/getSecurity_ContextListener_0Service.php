...
$this->services['security.context_listener.0'] = $instance = new \Symfony\Component\Security\Http\Firewall\ContextListener(${($_ = isset($this->services['security.token_storage']) ? $this->services['security.token_storage'] : ($this->services['security.token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())) && false ?: '_'}, new RewindableGenerator(function () {
    ...
    yield 1 => ${($_ = isset($this->services['security.user.provider.concrete.student']) ? $this->services['security.user.provider.concrete.student'] : $this->load('getSecurity_User_Provider_Concrete_StudentService.php')) && false ?: '_'};
    yield 2 => ${($_ = isset($this->services['security.user.provider.concrete.staff']) ? $this->services['security.user.provider.concrete.staff'] : $this->load('getSecurity_User_Provider_Concrete_StaffService.php')) && false ?: '_'};
