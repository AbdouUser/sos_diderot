 ...
 */
class calendar extends \AppBundle\Entity\calendar implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\calendar' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\calendar' . "\0" . 'date', '' . "\0" . 'AppBundle\\Entity\\calendar' . "\0" . 'day', '' . "\0" . 'AppBundle\\Entity\\calendar' . "\0" . 'hour', '' . "\0" . 'AppBundle\\Entity\\calendar' . "\0" . 'isHere'];
        }
