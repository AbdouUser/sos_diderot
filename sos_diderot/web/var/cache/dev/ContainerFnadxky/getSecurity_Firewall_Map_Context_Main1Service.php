...
// Returns the private 'security.firewall.map.context.main_1' shared service.
...
return $this->services['security.firewall.map.context.main_1'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 2 => ${($_ = isset($this->services['security.authentication.listener.form.main_1']) ? $this->services['security.authentication.listener.form.main_1'] : $this->load('getSecurity_Authentication_Listener_Form_Main1Service.php')) && false ?: '_'};
    yield 3 => ${($_ = isset($this->services['security.authentication.listener.anonymous.main_1']) ? $this->services['security.authentication.listener.anonymous.main_1'] : $this->load('getSecurity_Authentication_Listener_Anonymous_Main1Service.php')) && false ?: '_'};
...
}, 5), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, ${($_ = isset($this->services['security.authentication.trust_resolver']) ? $this->services['security.authentication.trust_resolver'] : ($this->services['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver('Symfony\\Component\\Security\\Core\\Authentication\\Token\\AnonymousToken', 'Symfony\\Component\\Security\\Core\\Authentication\\Token\\RememberMeToken'))) && false ?: '_'}, $b, 'main_1', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint(${($_ = isset($this->services['http_kernel']) ? $this->services['http_kernel'] : $this->getHttpKernelService()) && false ?: '_'}, $b, 'loginPro', false), NULL, NULL, ${($_ = isset($this->services['monolog.logger.security']) ? $this->services['monolog.logger.security'] : $this->load('getMonolog_Logger_SecurityService.php')) && false ?: '_'}, false), $c, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main_1', 'security.user_checker', 'security.request_matcher.tr7ono.', true, false, 'security.user.provider.concrete.db_provider_1', 'main_1', 'security.authentication.form_entry_point.main_1', NULL, NULL, [0 => 'form_login', 1 => 'anonymous'], NULL));
